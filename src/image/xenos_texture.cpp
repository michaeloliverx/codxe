...
uint32_t CalculatePitch(uint32_t width, const image::xenos_texture::TextureFormatInfo &formatInfo)
{
...
TextureLevelLayout CalculateLevelLayout(uint32_t width, uint32_t height, uint32_t mipLevel,
                                        const image::xenos_texture::TextureFormatInfo &formatInfo, uint32_t basePitch)
{
