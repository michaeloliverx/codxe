...
//     reinterpret_cast<char *(*)(const char *filename, const char *extFilename)>(0x8229E2D0);

// static auto GScr_AddFieldsForEntity = reinterpret_cast<void (*)()>(0x82229B08);

// static auto Scr_AddClassField =
//     reinterpret_cast<void (*)(unsigned int classnum, const char *name, unsigned __int16 offset)>(0x822A8AF0);
...
// static auto Scr_SetGenericField = reinterpret_cast<void (*)(unsigned __int8 *b, fieldtype_t type, int
// ofs)>(0x8222AAA8); static auto Scr_GetGenericField = reinterpret_cast<void (*)(unsigned __int8 *b, fieldtype_t type,
// int ofs)>(0x8222AC78); static auto Scr_GetObjectField = reinterpret_cast<void (*)(unsigned int classnum, int entnum,
// int offset)>(0x8222B228);
