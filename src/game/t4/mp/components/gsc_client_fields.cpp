...
client_fields_s client_fields_extended[] = {
    // Original fields
    {"name", 0, F_LSTRING, 0x00000000, reinterpret_cast<ClientFieldSetter>(0x82209910),
     reinterpret_cast<ClientFieldGetter>(0x82209A48)},
    {"sessionteam", 0, F_STRING, 0x00000000, reinterpret_cast<ClientFieldSetter>(0x82209948),
     reinterpret_cast<ClientFieldGetter>(0x82209AB8)},
    {"maxhealth", 14936, F_INT, 0x00000000, reinterpret_cast<ClientFieldSetter>(0x82209CD8), nullptr},
    {"headiconteam", 0, F_STRING, 0x00000000, reinterpret_cast<ClientFieldSetter>(0x82209FE8),
     reinterpret_cast<ClientFieldGetter>(0x8220A110)},
    ...
    {"sessionstate", 0, F_STRING, 0x00000000, reinterpret_cast<ClientFieldSetter>(0x82209B40),
     reinterpret_cast<ClientFieldGetter>(0x82209C50)},
    {"statusicon", 0, F_STRING, 0x00000000, reinterpret_cast<ClientFieldSetter>(0x82209E78),
     reinterpret_cast<ClientFieldGetter>(0x82209EB8)},
    {"spectatorclient", 14768, F_INT, 0x00000000, reinterpret_cast<ClientFieldSetter>(0x82209DA8), nullptr},
    {"archivetime", 14780, F_FLOAT, 0x00000000, reinterpret_cast<ClientFieldSetter>(0x8220A190),
     reinterpret_cast<ClientFieldGetter>(0x8220A1E0)},
    {"psoffsettime", 15124, F_INT, 0x00000000, reinterpret_cast<ClientFieldSetter>(0x8220A228),
     reinterpret_cast<ClientFieldGetter>(0x8220A260)},
    ...
    {"headicon", 0, F_STRING, 0x00000000, reinterpret_cast<ClientFieldSetter>(0x82209F08),
     reinterpret_cast<ClientFieldGetter>(0x82209F68)},
