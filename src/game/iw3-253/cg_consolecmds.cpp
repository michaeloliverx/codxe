...
namespace iw3_253
{
    ...
    Cmd_AddCommandInternal_t Cmd_AddCommandInternal = reinterpret_cast<Cmd_AddCommandInternal_t>(0x821843F0);
    ...
    Com_Printf_t Com_Printf = reinterpret_cast<Com_Printf_t>(0x82184A78);

    typedef void (*Com_PrintError_t)(conChannel_t channel, const char *fmt, ...);
    Com_PrintError_t Com_PrintError = reinterpret_cast<Com_PrintError_t>(0x82184BE8);
    ...
    DB_GetAllXAssetOfType_FastFile_t DB_GetAllXAssetOfType_FastFile = reinterpret_cast<DB_GetAllXAssetOfType_FastFile_t>(0x82124C30);
    ...
    auto cm = reinterpret_cast<clipMap_t *>(0x836CDB08);
